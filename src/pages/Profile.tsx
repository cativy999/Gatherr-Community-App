...
import { MapPin, LogOut, Pencil, Check, X, Loader2, CalendarDays, ChevronRight, Users } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-semibold">{groupCount} Published Groups</p>
                <p className="text-xs text-muted-foreground">Tap to view and manage</p>
              </div>
            </div>
            <ChevronRight className="h-4 w-4 text-muted-foreground group-hover:text-foreground transition-colors" />
